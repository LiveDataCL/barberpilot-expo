...
const s = StyleSheet.create({
  ...
  title:    { fontSize: 28, color: '#f0ebe0', textAlign: 'center', marginBottom: 10,
    fontFamily: 'CormorantGaramond_600SemiBold', letterSpacing: 0.3 },
  subtitle: { fontSize: 14, color: '#9c8f78', textAlign: 'center', lineHeight: 21,
    marginBottom: 36, fontFamily: 'DMSans_400Regular' },
  field:    { width: '100%', marginBottom: 18 },
  label:    { fontSize: 11, color: '#c9a84c', letterSpacing: 2,
    textTransform: 'uppercase', marginBottom: 8, fontFamily: 'DMSans_500Medium' },
  ...
  btnDis:   { opacity: 0.5 },
  btnTxt:   { fontSize: 15, color: '#0a0806', fontFamily: 'DMSans_700Bold',
    letterSpacing: 0.5 },
});
